...
interface SeguroFormProps {
  editingSeguro: Seguro | null;
  onBack: () => void;
}

export function SeguroForm({ editingSeguro, onBack }: SeguroFormProps) {
  return (
      ...
      <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-8 text-white">
          <h2 className="text-2xl font-bold">
            {editingSeguro ? 'Editar Plano de Seguro' : 'Cadastrar Novo Seguro'}
          </h2>
        ...
        <form className="p-8 space-y-10">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input 
                  type="text" 
                  defaultValue={editingSeguro?.name}
              ...
              <div>
                ...
                <select 
                  defaultValue={editingSeguro?.coverageType || ""}
              ...
              <div className="md:col-span-2">
                ...
                <textarea 
                  rows={3} 
                  defaultValue={editingSeguro?.description}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    type="number" 
                    defaultValue={editingSeguro?.coverageAmount}
                    placeholder="0,00"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    type="number" 
                    defaultValue={editingSeguro?.monthlyPrice}
                    placeholder="0,00"
                    className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 outline-none mb-1 cursor-text text-gray-900 placeholder-gray-400" 
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    type="number" 
                    defaultValue={editingSeguro?.deductible}
                    placeholder="0,00"
                    className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 outline-none mb-1 cursor-text text-gray-900 placeholder-gray-400" 
                  />
                </div>
          ...
          <div className="pt-8 border-t border-gray-100 flex flex-col sm:flex-row gap-4">
            ...
            >
              ...
              {editingSeguro ? 'Atualizar Plano' : 'Cadastrar Plano'}
            </button>
